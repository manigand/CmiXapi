...
abstract class ilCmiXapiAbstractReportLinkBuilder
{
    ...
    {
    ilObjCmiXapi::log()->debug('Dans getUrl de Abstractlinkbuilder');
    ...
    {
    ilObjCmiXapi::log()->debug('Dans appendRequestParameters de abstract');
    ...
    {
    ilObjCmiXapi::log()->debug('Dans buildPipelineParameter de abstract - pipeline= '.$this->buildPipeline()[0]);
