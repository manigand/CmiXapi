...
class ilCmiXapiHighscoreReportLinkBuilder extends ilCmiXapiAbstractReportLinkBuilder
{
    ...
    {
    ilObjCmiXapi::log()->debug('dans builpipeline de hightScore');
    $obj = $this->getObj();
        $pipeline = [];
        /*
    ...
    {
    ilObjCmiXapi::log()->debug('buildFilterStage deHsLinkBuilder');
        $stage = array();
    ...
    {
    ilObjCmiXapi::log()->debug('buildOrderStage deHsLinkBuilder');
        return [ '$sort' => [
    ...
    {
    ilObjCmiXapi::log()->debug('getUsersStack deHsLinkBuilder');
        $users = [];
        $obj = $this->getObj();
