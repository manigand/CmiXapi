...
class ilCmiXapiLaunchGUI
{
    ...
    $this->log()->debug('dans buildLaunchLink');
        ...
        $this->log()->debug('fin buildLaunchLink');
        return $launchLink;
    }
...
$this->log()->debug('dans getLaunchParams'.$params['endpoint']);        
        ...
        $this->log()->debug('fin getLaunchParams'.var_export($params, true)); 
        return $params;
    }
