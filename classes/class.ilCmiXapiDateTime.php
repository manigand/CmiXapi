...
class ilCmiXapiDateTime extends ilDateTime
{
    ...
    const RFC3336_EXTENDED_FIXED_USING_u_INSTEAD_OF_v = 'Y-m-d\TH:i:s.u'.'Z'; //modif suppression de 'p' en fin de chaine pour avoir un timestamp compatible à partir de php8, la terminaison 'P' pourra être ajoutée
