...
ilObjCmiXapi::log()->debug('dans ilCmiXapiStatementsTableGUI');        
...
ilObjCmiXapi::log()->debug('step4');
    ...
    {
        global $DIC; /* @var \ILIAS\DI\Container $DIC */
ilObjCmiXapi::log()->debug('dans initColumns');
...
ilObjCmiXapi::log()->debug('step2');
    ...
    {
        global $DIC; /* @var \ILIAS\DI\Container $DIC */
ilObjCmiXapi::log()->debug('dans initFilter');
        if ($this->isMultiActorReport) {
...
ilObjCmiXapi::log()->debug('step1.1');
            $si->setOptions(ilCmiXapiVerbList::getInstance()->getSelectOptions());
        } else { //xapi
ilObjCmiXapi::log()->debug('step1.2');
...
ilObjCmiXapi::log()->debug('fin initFilter');
    }
